...
@Command(label = "teleport", aliases = {"tp"}, permission = "player.teleport", requireTarget = true, desc = "/tp [relative x] [relative y] [relative z]. Teleports the player to the specified pos frm self.")
